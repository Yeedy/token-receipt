...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--agent-tool", choices=("auto", "codex", "claude-code", "trae", "kimi-code", "generic"), default=None, help="Software data source and receipt logo. When omitted, token-receipt uses the current runtime if it can detect one; otherwise it will ask you to disambiguate instead of guessing across software.")
    parser.add_argument("--brand", choices=("auto", "codex", "claude-code", "trae", "kimi-code", "generic"), default=None, help="Backward-compatible logo override. Prefer --agent-tool when choosing a software data source.")
