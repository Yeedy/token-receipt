...
from token_receipt.hooks import build_session_end_system_message  # noqa: E402
from token_receipt.models import DEFAULT_PRICING  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Emit a token-receipt systemMessage payload for Claude SessionEnd hooks.")
    ...
    try:
        ...
        payload = {
            "continue": True,
            "suppressOutput": True,
            "systemMessage": f"Token Receipt hook failed: {exc}",
        }
